-- Push Notifications Subscription Table - Fixed Migration
-- This table stores FCM tokens and user preferences for push notifications

-- Clean up any existing problematic tables/functions
DROP TABLE IF EXISTS push_subscriptions CASCADE;
DROP FUNCTION IF EXISTS find_nearby_users CASCADE;
...
CREATE INDEX idx_push_subscriptions_location ON push_subscriptions(user_location_lat, user_location_lng);
