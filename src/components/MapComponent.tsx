...
import { Crosshair, Layers, Mic, Heart, MapPin, Clock, MessageCircle, ZoomIn, ZoomOut } from 'lucide-react';
...
const VoiceChatControl: React.FC<{ onOpenVoiceChat: () => void }> = ({ onOpenVoiceChat }) => (
  <ControlButton
  ...
  return (
    <>
      ...
      <MapContainer center={center} zoom={zoom} scrollWheelZoom={true} style={{ height: '100%', width: '100%' }}>
        ...
        <VoiceChatControl onOpenVoiceChat={onOpenVoiceChat} />
