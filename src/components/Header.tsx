      ...
      <div style={{
        ...
        className="header-left-section">
          ...
          <div style={{
            ...
            `,
            border: '2px solid rgba(var(--accent-primary, #3b82f6), 0.3)',
            boxShadow: `
          ...
          >
            ...
            <div style={{
              ...
              bottom: '-2px',
              borderRadius: '50%',
              background: `linear-gradient(45deg, rgba(var(--accent-primary-rgb, 59, 130, 246), 0.1), transparent)`,
              opacity: 0.7,
          ...
          <button
            ...
            onMouseUp={(e) => {
              e.currentTarget.style.transform = isHomeHovered ? 'scale(1.02)' : 'scale(1)';
            }}
            onTouchStart={(e) => {
              e.currentTarget.style.transform = 'scale(0.95)';
            }}
            ...
            style={{
              ...
              background: activeTab === 'map'
                ? 'linear-gradient(135deg, var(--accent-primary) 0%, rgba(37, 99, 235, 0.9) 100%)'
                : `
                  linear-gradient(
                    135deg,
              ...
              color: activeTab === 'map' ? 'white' : 'var(--text-primary)',
              fontSize: '14px',
              fontWeight: '600',
              cursor: 'pointer',
              display: 'flex',
          ...
          >
            <i
              ...
              style={{
                ...
                transform: isHomeHovered ? 'scale(1.1)' : 'scale(1)'
              }}
            />
            <span style={{ fontSize: '14px', fontWeight: '600' }}>{t('tabs.map')}</span>
